# Generated by Django 4.1.1 on 2023-04-22 19:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('has_subscription', models.BooleanField(default=False, verbose_name='Has Subscription')),
                ('subscription_id', models.CharField(blank=True, max_length=100, null=True, verbose_name='Subscription ID')),
                ('subscription_start', models.IntegerField(blank=True, null=True, verbose_name='Subscription Start')),
                ('subscription_end', models.IntegerField(blank=True, null=True, verbose_name='Subscription End')),
                ('subscription_status', models.CharField(blank=True, default='none', max_length=100, null=True, verbose_name='Subscription Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner', models.ImageField(blank=True, null=True, upload_to='broadcaster', verbose_name='Banner')),
                ('profile_pic', models.ImageField(blank=True, null=True, upload_to='broadcaster', verbose_name='Profile Picture')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('solved_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='solved_by', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='oAuth2',
        ...
        migrations.CreateModel(
            name='BroadcasterContributeInvite',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message', models.TextField(max_length=256)),
                ('is_pending', models.BooleanField(default=True, verbose_name='Is Pending')),
                ('broadcaster', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='broadcaster', to='accounts.broadcaster')),
